...
def render_botstatus_page(
    ...
    *,
    ...
    lines = [
        ...
        f"Active Polling Owners: {diagnostics['active_instance_count']}",
        f"Duplicate Active Pollers: {diagnostics['duplicate_instance_count']}",
        f"Non-Polling Heartbeats: {diagnostics['non_polling_instance_count']}",
        f"Stale Bot Heartbeats: {diagnostics['stale_instance_count']}",
        ...
        f"- Non-polling records: {diagnostics['non_polling_instance_count']}",
        f"- Stale/dead records: {diagnostics['stale_instance_count']}",
        "",
