...
class Settings(BaseSettings):
    ...
    reality_calibration_enabled: bool = Field(default=True, alias="REALITY_CALIBRATION_ENABLED")
    ...
    search_daily_limit: int = Field(default=25, alias="SEARCH_DAILY_LIMIT")
    search_timeout_seconds: int = Field(default=12, alias="SEARCH_TIMEOUT_SECONDS")
    search_default_recency_days: int | None = Field(default=None, alias="SEARCH_DEFAULT_RECENCY_DAYS")
